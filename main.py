...
s_block_result = s_block(input_data)
p_block_result = p_block(s_block_result)
s_block_inverse_result = s_block_inverse(input_data)

# Вивід результатів
print(f'Input:  {bin(input_data)}')
print(f'S-Block:  {bin(s_block_result)}')
print(f'P-Block: {bin(p_block_result)}')
print(f'S-Block Inverse: {bin(s_block_inverse_result)}')